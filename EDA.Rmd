...
length(nonzero_features)  # how many genes are nonzero at λ.1se?
...
```{r}
# Use λ.1se for a sparser, more stable model
pred_multi <- predict(
  cv_fit_multi_100,
  newx = X_test_100,
